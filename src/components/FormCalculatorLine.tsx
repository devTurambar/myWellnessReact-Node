    ...
    return (
        <div className="w-full grid grid-flow-row sm:grid-flow-col grid-auto-column-form gap-2">
            <div className="ingredient flex flex-col flex-1">
                ...
                <input className="bg-gray-200 border-2 rounded" type="text" form="formCalc" required />
            </div>
            <div className="flex gap-2 flex-1">
                <div className="status flex flex-col w-1/2">
                    ...
                    <select className="bg-gray-200 border-2 rounded" form="formCalc">
                        <option>
                ...
                <div className="weight flex flex-col w-1/2">
                    ...
                    <input className="bg-gray-200 border-2 rounded" type="number" form="formCalc" required/>
                </div> 
            </div>                 
        </div>
    )
